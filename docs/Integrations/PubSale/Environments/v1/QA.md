...
EXTRACT_PURCHASE_ORDERS_REPOSITORY=QA_KFC_POS_PurchaseOrders
```
...
EXTRACT_CATALOG_REPOSITORY=QA_KFC_MXPi_Settings
...
EXTRACT_INTERNAL_CLIENTS_REPOSITORY=QA_KFC_POS_InternalClients
...
EXTRACT_HOMOLOGATION_REPOSITORY=QA_KFC_MXPi-Homologation_v1_v2
...
LOAD_REPOSITORY=QA_KFC_MXPi_PubSale
LOAD_ADAPTER=Mongo
```
...
LOAD_LOGS_REPOSITORY=QA_KFC_MXPi_PubSIR
...
URL_SIR=http://4.153.178.250:5000/api/v1/facade
SERVICE_TIMEOUT=10
```
