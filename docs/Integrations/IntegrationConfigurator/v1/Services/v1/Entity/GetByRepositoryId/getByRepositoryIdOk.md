## Obtener Entidades por ID de Repositorio
...
```
{{server_orchestrator}}/entities/getByRepositoryId
```
...
| -------------- | -------------------------------------- | ----------------------------------------------- |
| `repositoryId` | `6bd36e91-c0de-4b6d-87b8-5dea7f2c2274` | ID del repositorio para consultar sus entidades |
...
```json
{
  ...
  "data": {
    "entities": [
      ...
      {
        "id": "476144bf-ccf5-4702-ac06-42dc640b78e9",
        "code": "2",
        "name": "plu_menu",
        "typeId": "d528abf5-ec41-4c8f-9bc1-8211855c3749",
        "repositoryId": "6bd36e91-c0de-4b6d-87b8-5dea7f2c2274",
...
| `data.entities`                         | Array con las entidades del repositorio consultado |
