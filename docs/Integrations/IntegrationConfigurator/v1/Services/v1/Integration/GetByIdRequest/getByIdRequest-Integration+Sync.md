## Obtener Integración por ID y SyncId
...
La respuesta contiene la configuración completa de la integración sincronizada, incluyendo código, país, ID de franquicia y sus procesos de extracción (EXTRACTS), transformación (TRANSFORMS) y carga (LOADS) con sus respectivos syncIds.
