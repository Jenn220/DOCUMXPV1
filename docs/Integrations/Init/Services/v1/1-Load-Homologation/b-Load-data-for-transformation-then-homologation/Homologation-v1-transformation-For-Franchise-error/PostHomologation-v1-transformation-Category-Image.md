## Ejecutar Proceso ETL Facade para Imágenes de Categoría
    ...
    "EXTRACTS": [
      {
        ...
        "configuration": {
          ...
          "entities": [
            {
              "name": "transformation_category_image",
              "properties": [
                {
                  "name": "combined_id",
                  "type": "base64"
...
| `processes.EXTRACTS[].configuration.entities[].name`                   | string  | Nombre de la entidad (transformation_category_image) |
