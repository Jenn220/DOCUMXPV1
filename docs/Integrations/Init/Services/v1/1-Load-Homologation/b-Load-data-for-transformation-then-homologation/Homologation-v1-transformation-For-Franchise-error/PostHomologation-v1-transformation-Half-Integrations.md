## Ejecutar Proceso ETL Facade para Integración Media
    ...
    "EXTRACTS": [
      {
        ...
        "configuration": {
          ...
          "entities": [
            {
              "name": "transformation_half_integration",
              "properties": [
                {
                  "name": "combined_id",
                  "type": "base64"
...
| `processes.EXTRACTS[].configuration.entities[].name`                   | string  | Nombre de la entidad (transformation_half_integration) |
