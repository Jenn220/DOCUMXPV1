## Ejecutar Proceso ETL Facade para Clasificaciones de Transformación
    ...
    "EXTRACTS": [
      {
        ...
        "configuration": {
          ...
          "entities": [
            {
              "name": "transformation_classifications",
              "properties": [
                {
                  "name": "combined_id",
                  "type": "base64"
...
| `franchise_id`                                                         | string  | ID de la cadena del MXP legacy                        |
...
| `processes.EXTRACTS[].configuration.connection.adapter`                | string  | Tipo de adaptador (Mongo)                             |
| `processes.EXTRACTS[].configuration.entities`                          | array   | Array de entidades a extraer                          |
| `processes.EXTRACTS[].configuration.entities[].name`                   | string  | Nombre de la entidad (transformation_classifications) |
