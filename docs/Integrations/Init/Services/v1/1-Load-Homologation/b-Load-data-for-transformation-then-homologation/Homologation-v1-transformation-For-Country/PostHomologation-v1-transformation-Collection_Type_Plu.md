## Ejecutar Proceso ETL Facade para Colección de Datos Plus - Tipo Producto
...
| `franchise_id`                                                         | number  | ID de la franquicia (0 para todas)                   |
...
| `processes.EXTRACTS[].configuration.entities[].name`                   | string  | Nombre de la entidad (transformation_collection_plu) |
