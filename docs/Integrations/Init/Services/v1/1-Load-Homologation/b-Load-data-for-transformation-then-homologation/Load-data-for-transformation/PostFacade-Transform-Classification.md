## Ejecutar Proceso ETL Facade para Clasificaciones
...
| ---------------------------------------------------------------------- | ------- | ------------------------------------------------- |
| `code`                                                                 | string  | Código del proceso facade (F001)                  |
...
| `processes.EXTRACTS[].configuration.entities[].name`                   | string  | Nombre de la entidad (Clasificacion/uuids)        |
...
| `processes.TRANSFORMS[].code`                                          | string  | Código del proceso de transformación (T033)       |
