## Ejecutar Proceso ETL Facade para Medio de Venta
          ...
          "entities": [
            {
              ...
              "properties": [
                {
                  "name": "legacy_medio_canal_menu_id",
                  "type": "base64"
                },
                {
                  "name": "legacy_medio_venta_id",
                  "type": "base64"
                },
                {
                  "name": "half_integration_name",
                  "type": "base64"
                }
              ],
              "filters": []
    ...
    "LOADS": [
      {
        ...
        "configuration": {
          ...
          "entities": [
            {
              "name": 0,
              "toName": "transformation_half_integration",
              "properties": [
                {
                  "fromName": "id_v1",
                  "fromType": "",
...
| `processes.EXTRACTS[].configuration.entities[].name`                   | string  | Nombre de la entidad (mxp_v2.Medio_Venta/uuids)   |
...
| `processes.TRANSFORMS[].code`                                          | string  | Código del proceso de transformación (T034)       |
...
| `processes.LOADS[].configuration.entities[].name`                      | number  | Índice de la entidad extraída                     |
