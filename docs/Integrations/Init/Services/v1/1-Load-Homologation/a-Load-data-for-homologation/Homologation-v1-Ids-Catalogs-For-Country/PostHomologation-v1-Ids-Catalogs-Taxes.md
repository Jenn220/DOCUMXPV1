## Ejecutar Proceso ETL Facade para Impuestos
          ...
          "entities": [
            {
              ...
              "filters": [
                ...
                },
                {
                  "name": "IDStatus",
                  "operator": "equals",
                  "value": "0c377262-660e-e611-80c7-0050568602d0"
                }
              ]
            }
          ]
...
| `processes.EXTRACTS[].configuration.entities[].name`                   | string  | Nombre de la entidad (Impuestos)                  |
