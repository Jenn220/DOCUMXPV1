## Ejecutar Proceso ETL Facade para Colección Departamento PLU
...
| `processes.EXTRACTS[].configuration.entities[].name`                   | string  | Nombre de la entidad (mxp_v2.Coleccion_Departamento_Plu) |
