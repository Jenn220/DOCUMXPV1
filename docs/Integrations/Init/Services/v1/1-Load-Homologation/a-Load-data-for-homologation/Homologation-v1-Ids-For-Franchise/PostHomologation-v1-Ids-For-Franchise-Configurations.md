## Ejecutar Proceso ETL Facade para Configuraciones de Franquicia
...
| `processes.EXTRACTS[].configuration.entities[].name`                   | string  | Nombre de la entidad (mxp_v2.View_Franchise_Configurations) |
