## Ejecutar Flujo de Integración - Número de PLU por PLU
    ...
    "LOADS": [
      {
        ...
        "configuration": {
          ...
          "entities": [
            {
              "name": "plu_num_plu",
              "toName": "Pub_Sale_Sale_Product_Num",
              "properties": [
                {
                  "fromName": "country_id",
                  "fromType": "",
...
| `processes.EXTRACTS[].configuration.entities[].name`                   | string       | Nombre del stored procedure a extraer                     |
