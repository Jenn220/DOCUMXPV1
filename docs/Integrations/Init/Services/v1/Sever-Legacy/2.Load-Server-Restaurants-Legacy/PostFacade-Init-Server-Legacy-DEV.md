## Ejecutar Flujo de Integración - Configuración de Servidores Legacy
        ...
        "LOADS": [
            {
                ...
                "configuration": {
                    ...
                    "entities": [
                        {
                            "name": "server_legacy",
                            "toName": "Settings_BO_MXPLegacy_Server_Settings",
                            "properties": [
                                {
                                    "fromName": "country_id",
                                    "fromType": "",
                                ...
                                {
                                    "fromName": "server_config",
                                    "fromType": "",
                                    "toName": "server_config",
                                    "toType": "array",
                                    "defaultValue": ""
                                },
                                {
                                    ...
                                    "defaultValue": [
                                        ...
                                        {
                                            "fromName": "cash_register_ip",
                                            "fromType": "",
                                            "toName": "cash_register_ip",
                                            "toType": "string",
                                            "defaultValue": ""
                                        }
                                    ]
...
| `chunkLoad`                                                            | number       | Tamaño del lote de carga                                  |
...
| `processes.EXTRACTS[].configuration.entities[].name`                   | string       | Nombre de la tabla/entidad/stored procedure a extraer     |
...
| `processes.LOADS[].configuration.entities[].properties[].defaultValue` | string/array | Valor por defecto o configuración de propiedades anidadas |
