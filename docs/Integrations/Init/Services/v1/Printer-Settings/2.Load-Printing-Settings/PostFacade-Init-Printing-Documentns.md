## Ejecutar Flujo de Integración - Documentos de Impresión
        ...
        "EXTRACTS": [
            {
                ...
                "configuration": {
                    ...
                    "entities": [
                        {
                            "name": "mxp_v2.USP_Printing_Documents",
                            "properties": [],
                            "filters": [
                                {
                                    "name": "cdn_id",
                    ...
                    "entities": [
                        {
                            ...
                            "filters": [
                                ...
                                },
                                {
                                    "name": "entity_name",
                                    "operator": "equals",
                                    "value": "mxp_v2.View_Printing_Documents"
                                },
                                {
                                    "name": "franchise_id",
                                    "operator": "equals",
        ...
        "LOADS": [
            {
                ...
                "configuration": {
                    ...
                    "entities": [
                        {
                            "name": "printing_documents",
                            "toName": "Settings_BO_Printing_Documents",
                            "properties": [
                                {
                                    "fromName": "homologated_id",
                                    "fromType": "",
                                    "toName": "_id",
                                    "toType": "uuid",
                                    "defaultValue": "",
                                ...
                                {
                                    "fromName": "document_name",
                                    "fromType": "",
                                    "toName": "document_name",
                                    "toType": "",
                                    "defaultValue": ""
                                },
                                {
                                    "fromName": "document_key",
                                    "fromType": "",
                                    "toName": "document_key",
                                    "toType": "",
                                    "defaultValue": ""
                                ...
                                {
                                    "fromName": "document_template",
                                    "fromType": "",
                                    "toName": "document_template",
                                    "toType": "",
                                    "defaultValue": ""
                                }
                            ]
...
| `processes.EXTRACTS[].configuration.entities[].name`                   | string  | Nombre de la tabla/stored procedure a extraer             |
