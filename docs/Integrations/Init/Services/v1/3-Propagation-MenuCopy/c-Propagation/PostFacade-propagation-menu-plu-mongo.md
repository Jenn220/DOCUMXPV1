## Ejecutar Flujo de Integración - Carga de PLU en Base de Datos POS (Facade)
          ...
          "entities": [
            {
              ...
              "filters": [
                ...
                },
                {
                  "name": "entity_name",
                  "operator": "equals",
                  "value": "transformation_classifications"
                },
                {
                  "name": "entity_name",
                  "operator": "equals",
                  "value": "mxp_v2.Coleccion_Departamento_Plu"
                },
                {
                  "name": "entity_name",
                  "operator": "equals",
                ...
                },
                {
                  "name": "entity_name",
                  "operator": "equals",
                  "value": "Pregunta_Sugerida"
                },
                {
                  "name": "entity_name",
                  "operator": "equals",
                  "value": "mxp_v2.View_Answer_For_Franchise"
                }
              ]
            }
          ]
    ...
    "LOADS": [
      {
        ...
        "configuration": {
          "connection": {
            ...
            "user": "{{user_mongo}}",
            "password": "{{pass_mongo}}",
            "repository": "UAT_KFC_POS_Menus",
            "adapter": "{{adapter_mongo}}"
          },
          "entities": [
            {
              "name": "plus",
              "toName": "Menus_POS_PLU",
              "properties": [
                {
                  "fromName": "_id",
                  "fromType": "",
...
| `processes.LOADS[].configuration.connection`    | object  | Configuración de conexión a base de datos POS |
