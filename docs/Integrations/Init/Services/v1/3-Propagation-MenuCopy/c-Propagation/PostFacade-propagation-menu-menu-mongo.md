## Ejecutar Flujo de Integración - Carga de Menú en Base de Datos BO (Facade)
          ...
          "entities": [
            {
              ...
              "filters": [
                ...
                },
                {
                  "name": "entity_name",
                  "operator": "equals",
                  "value": "transformation_half_integration"
                },
                {
                  "name": "entity_name",
                  "operator": "equals",
                  "value": "mxp_v2.View_Device_Menus_PLU"
                },
                {
                  "name": "entity_name",
                  "operator": "equals",
...
| `processes.LOADS[].configuration.connection`    | object  | Configuración de conexión a base de datos BO |
