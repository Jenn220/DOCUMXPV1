## Ejecutar Flujo de Integración - Homologación de UUIDs Pregunta Sugerida (Facade)
    ...
    "EXTRACTS": [
      {
        ...
        "configuration": {
          ...
          "entities": [
            {
              "name": "Pregunta_Sugerida",
              "properties": [
                {
                  "name": "IDPreguntaSugerida",
                  "type": "base64"
                }
              ],
              "filters": [
                ...
                },
                {
                  "name": "IDStatus",
                  "operator": "equals",
                  "value": "90039503-85cf-e511-80c6-000d3a3261f3"
                }
              ]
            }
          ]
