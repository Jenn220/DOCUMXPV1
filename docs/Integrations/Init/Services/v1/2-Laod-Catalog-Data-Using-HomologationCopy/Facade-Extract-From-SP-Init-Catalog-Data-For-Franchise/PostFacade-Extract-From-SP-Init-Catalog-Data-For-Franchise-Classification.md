## Ejecutar Flujo de Integración - Catálogo de Clasificaciones de Franquicia (Facade)
          ...
          "entities": [
            {
              ...
              "filters": [
                ...
                },
                {
                  "name": "option",
                  "operator": "equals",
                  "value": "catalog_for_franchise_classification"
                }
              ]
            }
          ]
          ...
          "entities": [
            {
              ...
              "filters": [
                ...
                },
                {
                  "name": "entity_name",
                  "operator": "in",
                  "value": ["Cadena", "transformation_classifications"]
                }
              ]
            },
            {
    ...
    "LOADS": [
      {
        ...
        "configuration": {
          ...
          "entities": [
            {
              "name": "catalog_for_franchise_classification",
              "toName": "Configurations_BO_Classification",
              "properties": [
                {
                ...
                {
                  "fromName": "classification_name",
                  "fromType": "",
                  "toName": "classification_name",
                  "toType": "",
                  "defaultValue": ""
                },
                {
