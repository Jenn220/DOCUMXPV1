## Ejecutar Flujo de Integración - Catálogo de Configuraciones de Franquicia (Facade)
          ...
          "entities": [
            {
              ...
              "filters": [
                ...
                },
                {
                  "name": "option",
                  "operator": "equals",
                  "value": "catalog_for_franchise_configurations"
                }
              ]
            }
          ]
          ...
          "entities": [
            {
              ...
              "filters": [
                ...
                },
                {
                  "name": "entity_name",
                  "operator": "in",
                  "value": ["Cadena", "mxp_v2.View_Franchise_Configurations"]
                }
              ]
            },
            {
    ...
    "LOADS": [
      {
        ...
        "configuration": {
          ...
          "entities": [
            {
              "name": "catalog_for_franchise_configurations",
              "toName": "InternalClients_BO_Franchise_Configurations",
              "properties": [
                {
                ...
                {
                  "fromName": "menu_deep_level_nested",
                  "fromType": "",
                  "toName": "menu_deep_level_nested",
                  "toType": "",
                  "defaultValue": ""
                },
                {
