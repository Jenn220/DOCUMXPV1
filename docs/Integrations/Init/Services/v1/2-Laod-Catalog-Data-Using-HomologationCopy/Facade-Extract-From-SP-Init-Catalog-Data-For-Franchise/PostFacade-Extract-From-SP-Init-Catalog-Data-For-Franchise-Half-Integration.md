## Ejecutar Proceso ETL Facade para Catálogo de Integración Media de Franquicia
          ...
          "entities": [
            {
              ...
              "filters": [
                ...
                },
                {
                  "name": "option",
                  "operator": "equals",
                  "value": "catalog_for_franchise_half_integration"
                }
              ]
            }
          ]
          ...
          "entities": [
            {
              ...
              "filters": [
                ...
                },
                {
                  "name": "entity_name",
                  "operator": "in",
                  "value": ["Cadena", "transformation_half_integration"]
                },
                {
                  "name": "franchise_id",
                  "operator": "equals",
    ...
    "LOADS": [
      {
        ...
        "configuration": {
          ...
          "entities": [
            {
              "name": "catalog_for_franchise_half_integration",
              "toName": "Menus_BO_Half_Integration",
              "properties": [
                {
...
| `processes.TRANSFORMS[].code`                                          | string  | Código del proceso de transformación (T022)                    |
