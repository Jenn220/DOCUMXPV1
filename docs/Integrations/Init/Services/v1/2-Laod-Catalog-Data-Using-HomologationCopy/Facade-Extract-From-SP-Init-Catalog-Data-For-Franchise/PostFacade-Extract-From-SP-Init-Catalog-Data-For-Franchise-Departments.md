## Ejecutar Proceso ETL Facade para Catálogo de Departamentos de Franquicia
          ...
          "entities": [
            {
              ...
              "filters": [
                ...
                },
                {
                  "name": "option",
                  "operator": "equals",
                  "value": "catalog_for_franchise_departments"
                }
              ]
            }
          ]
          ...
          "entities": [
            {
              ...
              "filters": [
                ...
                },
                {
                  "name": "entity_name",
                  "operator": "in",
                  "value": ["Cadena", "mxp_v2.Coleccion_Departamento_Plu"]
                }
              ]
            },
            {
    ...
    "LOADS": [
      {
        ...
        "configuration": {
          ...
          "entities": [
            {
              "name": "catalog_for_franchise_departments",
              "toName": "Configurations_BO_Departament_Internal",
              "properties": [
                {
                ...
                {
                  "fromName": "departament_internal_name",
                  "fromType": "",
                  "toName": "departament_internal_name",
                  "toType": "",
                  "defaultValue": ""
                },
                {
...
| `processes.EXTRACTS[].configuration.entities[].filters[].operator`     | string  | Operador de comparación (equals/in)                            |
| `processes.EXTRACTS[].configuration.entities[].filters[].value`        | mixed   | Valor del filtro (string o array)                              |
| `processes.TRANSFORMS`                                                 | array   | Array de procesos de transformación                            |
| `processes.TRANSFORMS[].code`                                          | string  | Código del proceso de transformación (T021)                    |
