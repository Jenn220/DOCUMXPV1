## Ejecutar Flujo de Integración - Catálogo de Restaurantes por Franquicia (Facade)
          ...
          "entities": [
            {
              ...
              "filters": [
                ...
                },
                {
                  "name": "option",
                  "operator": "equals",
                  "value": "catalog_for_franchise_restaurant"
                }
              ]
            }
          ]
              ...
              "filters": [
                {
                  "name": "entity_name",
                  "operator": "in",
                  "value": ["Restaurante", "Pais", "Provincia", "Ciudad"]
                }
              ]
            }
          ]
    ...
    "LOADS": [
      {
        ...
        "configuration": {
          ...
          "entities": [
            {
              "name": "catalog_for_franchise_restaurant",
              "toName": "InternalClients_BO_Restaurant",
              "properties": [
                {
                ...
                {
                  "fromName": "cdn_restaurant_id",
                  "fromType": "",
                  "toName": "cdn_restaurant_id",
                  "toType": "",
                  "defaultValue": ""
                },
                {
