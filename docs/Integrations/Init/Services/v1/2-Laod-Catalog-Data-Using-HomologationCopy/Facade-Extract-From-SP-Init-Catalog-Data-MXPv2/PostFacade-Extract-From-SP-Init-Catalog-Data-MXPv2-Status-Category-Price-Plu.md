## Ejecutar Proceso ETL Facade para Catálogo de Estado de Categoría Precio PLU MXPv2
          ...
          "entities": [
            {
              ...
              "filters": [
                ...
                },
                {
                  "name": "option",
                  "operator": "equals",
                  "value": "catalog_mxpv2_status_category_price_plu"
                }
              ]
            }
          ]
            ...
            },
            {
              ...
              "filters": [
                ...
                },
                {
                  "name": "entity_name",
                  "operator": "equals",
                  "value": "mxp_v2.View_Status_Category_PLU"
                }
              ]
            }
          ]
    ...
    "LOADS": [
      {
        ...
        "configuration": {
          ...
          "entities": [
            {
              "name": "catalog_mxpv2_status_category_price_plu",
              "toName": "Menus_BO_Status_Category_PLU",
              "properties": [
                {
                ...
                {
                  "fromName": "background_color",
                  "fromType": "",
                  "toName": "background_color",
                  "toType": "",
                  "defaultValue": ""
                },
                {
...
| `processes.TRANSFORMS[].code`                                          | string  | Código del proceso de transformación (T025)                    |
