## Ejecutar Proceso ETL Facade para Catálogo de Estado de PLU MXPv2
          ...
          "entities": [
            {
              ...
              "filters": [
                ...
                },
                {
                  "name": "option",
                  "operator": "equals",
                  "value": "catalog_mxpv2_status_plu"
                }
              ]
            }
          ]
    ...
    "LOADS": [
      {
        ...
        "configuration": {
          ...
          "entities": [
            {
              "name": "catalog_mxpv2_status_plu",
              "toName": "Menus_BO_Status_PLU",
              "properties": [
                {
...
| `processes.TRANSFORMS[].code`                                          | string  | Código del proceso de transformación (T026)                    |
...
| `processes.LOADS[].code`                                               | string  | Código del proceso de carga (LOO1)                             |
