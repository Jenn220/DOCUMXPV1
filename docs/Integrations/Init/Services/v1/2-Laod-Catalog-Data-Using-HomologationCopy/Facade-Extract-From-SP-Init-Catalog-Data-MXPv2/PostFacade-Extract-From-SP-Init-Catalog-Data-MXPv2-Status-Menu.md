## Ejecutar Proceso ETL Facade para Catálogo de Estado de Menú MXPv2
          ...
          "entities": [
            {
              ...
              "filters": [
                ...
                },
                {
                  "name": "option",
                  "operator": "equals",
                  "value": "catalog_mxpv2_status_menu"
                }
              ]
            }
          ]
    ...
    "LOADS": [
      {
        ...
        "configuration": {
          ...
          "entities": [
            {
              "name": "catalog_mxpv2_status_menu",
              "toName": "Menus_BO_Status_Menu",
              "properties": [
                {
...
| `processes.TRANSFORMS[].code`                                          | string  | Código del proceso de transformación (T029)                    |
