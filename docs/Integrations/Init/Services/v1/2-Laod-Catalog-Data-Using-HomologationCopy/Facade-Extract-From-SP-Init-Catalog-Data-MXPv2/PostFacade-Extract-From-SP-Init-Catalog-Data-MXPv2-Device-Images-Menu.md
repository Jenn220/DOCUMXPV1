## Ejecutar Proceso ETL Facade para Catálogo de Dispositivos de Imágenes de Menú MXPv2
          ...
          "entities": [
            {
              ...
              "filters": [
                ...
                },
                {
                  "name": "option",
                  "operator": "equals",
                  "value": "catalog_mxpv2_device_images_menu"
                }
              ]
            }
          ]
    ...
    "LOADS": [
      {
        ...
        "configuration": {
          ...
          "entities": [
            {
              "name": "catalog_mxpv2_device_images_menu",
              "toName": "Menus_BO_Device_Images_Menu",
              "properties": [
                {
...
| `processes.TRANSFORMS[].code`                                          | string  | Código del proceso de transformación (T028)                    |
