## Ejecutar Proceso ETL Facade para Catálogo de Tipo de Pregunta MXPv2
          ...
          "entities": [
            {
              ...
              "filters": [
                ...
                },
                {
                  "name": "option",
                  "operator": "equals",
                  "value": "catalog_mxpv2_type_question"
                }
              ]
            }
          ]
    ...
    "LOADS": [
      {
        ...
        "configuration": {
          ...
          "entities": [
            {
              "name": "catalog_mxpv2_type_question",
              "toName": "Menus_BO_Type_Suggested_Question",
              "properties": [
                {
...
| `processes.TRANSFORMS[].code`                                          | string  | Código del proceso de transformación (T027)                    |
