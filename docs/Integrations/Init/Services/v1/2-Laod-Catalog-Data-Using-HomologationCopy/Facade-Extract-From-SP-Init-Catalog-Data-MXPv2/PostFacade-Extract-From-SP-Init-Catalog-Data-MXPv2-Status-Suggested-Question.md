## Ejecutar Proceso ETL Facade para Catálogo de Estado de Preguntas Sugeridas MXPv2
...
| `processes.TRANSFORMS[].code`                                          | string  | Código del proceso de transformación (T030)                    |
