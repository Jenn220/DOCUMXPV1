## Ejecutar Flujo de Integración - Catálogo de Impuestos (Facade)
    ...
    "LOADS": [
      {
        ...
        "configuration": {
          ...
          "entities": [
            {
              "name": "catalog_taxes",
              "toName": "Configurations_BO_Taxes",
              "properties": [
                {
...
| `country`                                       | string  | Sí        | Código del país                      |
| `franchise_id`                                  | string  | Sí        | ID de la franquicia en legacy        |
