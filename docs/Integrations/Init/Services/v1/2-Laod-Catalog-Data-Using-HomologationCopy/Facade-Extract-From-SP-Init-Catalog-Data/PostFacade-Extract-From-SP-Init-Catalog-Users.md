## Ejecutar Flujo de Integración (Facade)
    ...
    "LOADS": [
      {
        ...
        "configuration": {
          ...
          "entities": [
            {
              "name": "catalog_user_admin",
              "toName": "InternalClients_BO_Users",
              "properties": [
                {
                ...
                {
                  "fromName": "user_last_name",
                  "fromType": "",
                  "toName": "user_last_name",
                  "toType": "",
                  "defaultValue": ""
                },
                {
...
| `chunkLoad`                                                | integer | No        | Tamaño del chunk para carga          |
...
| `processes.EXTRACTS[].configuration.connection.server`     | string  | No        | Servidor de conexión                 |
| `processes.EXTRACTS[].configuration.connection.port`       | string  | No        | Puerto de conexión                   |
| `processes.EXTRACTS[].configuration.connection.user`       | string  | No        | Usuario de conexión                  |
| `processes.EXTRACTS[].configuration.connection.password`   | string  | No        | Contraseña de conexión               |
| `processes.EXTRACTS[].configuration.connection.repository` | string  | No        | Nombre del repositorio               |
| `processes.EXTRACTS[].configuration.connection.adapter`    | string  | No        | Tipo de adaptador                    |
| `processes.EXTRACTS[].configuration.entities`              | array   | No        | Lista de entidades a extraer         |
| `processes.EXTRACTS[].configuration.entities[].name`       | string  | No        | Nombre de la entidad                 |
| `processes.EXTRACTS[].configuration.entities[].properties` | array   | No        | Lista de propiedades                 |
| `processes.EXTRACTS[].configuration.entities[].filters`    | array   | No        | Lista de filtros                     |
...
| `processes.LOADS[].configuration.connection`               | object  | No        | Configuración de conexión            |
| `processes.LOADS[].configuration.entities`                 | array   | No        | Lista de entidades a cargar          |
| `processes.LOADS[].configuration.entities[].name`          | string  | No        | Nombre de la entidad origen          |
| `processes.LOADS[].configuration.entities[].toName`        | string  | No        | Nombre de la entidad destino         |
| `processes.LOADS[].configuration.entities[].properties`    | array   | No        | Lista de propiedades de mapeo        |
