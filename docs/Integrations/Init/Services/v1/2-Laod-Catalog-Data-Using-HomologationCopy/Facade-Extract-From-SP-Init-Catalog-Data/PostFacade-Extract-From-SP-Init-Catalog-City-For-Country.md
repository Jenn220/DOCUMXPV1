## Ejecutar Flujo de Integración - Catálogo de Ciudades por País (Facade)
          ...
          "entities": [
            {
              ...
              "filters": [
                ...
                },
                {
                  "name": "option",
                  "operator": "equals",
                  "value": "catalog_province_for_country"
                }
              ]
            }
          ]
          ...
          "entities": [
            {
              ...
              "filters": [
                ...
                },
                {
                  "name": "option",
                  "operator": "equals",
                  "value": "catalog_city_for_country"
                }
              ]
            }
          ]
    ...
    "LOADS": [
      {
        ...
        "configuration": {
          ...
          "entities": [
            {
              "name": "catalog_city_for_country",
              "toName": "InternalClients_BO_City",
              "properties": [
                {
