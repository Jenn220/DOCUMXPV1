...
| ------------------------------------------------------------------------------ | ------- | ---------------------------------------------------------------------- |
| `typePrinter`                                                                  | string  | Tipo de impresión (VENTA-CUPON)                                        |
...
| `transaction.pointOfSale.account`                                              | string  | Cuenta autorizada (franquicia)                                         |
...
| `transaction.order.products[].productId`                                       | string  | ID de producto                                                         |
| `transaction.order.products[].product`                                         | string  | Nombre del producto vendido                                            |
| `transaction.order.products[].quantity`                                        | number  | Cantidad de producto vendido                                           |
| `transaction.order.products[].productComment`                                  | string  | Comentario de producto vendido                                         |
...
| `transaction.order.products[].price.totalPrice`                                | object  | Detalles de totales por la cantidad de producto                        |
| `transaction.order.products[].price.totalPrice.currencyCode`                   | string  | Código de moneda                                                       |
| `transaction.order.products[].price.totalPrice.subtotalWithoutTaxes`           | number  | Subtotal sin impuestos                                                 |
| `transaction.order.products[].price.totalPrice.discountPercentage`             | number  | Porcentaje de descuento                                                |
| `transaction.order.products[].price.totalPrice.discountsValue`                 | number  | Valor de descuentos                                                    |
| `transaction.order.products[].price.totalPrice.subtotalIncludeDiscounts`       | number  | Subtotal incluyendo descuentos                                         |
| `transaction.order.products[].price.totalPrice.taxesPercentage`                | number  | Porcentaje de impuestos                                                |
| `transaction.order.products[].price.totalPrice.taxValue`                       | number  | Valor de impuesto                                                      |
| `transaction.order.products[].price.totalPrice.total`                          | number  | Total                                                                  |
| `transaction.order.products[].price.totalPrice.totalBeforeSale`                | number  | Total antes de venta                                                   |
| `transaction.order.products[].price.totalPrice.suggestedPrice`                 | number  | Precio sugerido                                                        |
| `transaction.order.products[].modifierGroups`                                  | array   | Modificadores de producto                                              |
...
| `transaction.shippingMethod.store`                                             | object  | Información de la tienda                                               |
...
| `transaction.shippingMethod.store.latitude`                                    | number  | Latitud de la tienda                                                   |
| `transaction.shippingMethod.store.longitude`                                   | number  | Longitud de la tienda                                                  |
| `transaction.shippingMethod.delivery`                                          | object  | Información de entrega a domicilio                                     |
| `transaction.shippingMethod.delivery.deliveryDate`                             | string  | Fecha de entrega                                                       |
| `transaction.shippingMethod.delivery.latitude`                                 | string  | Latitud de entrega                                                     |
| `transaction.shippingMethod.delivery.longitude`                                | string  | Longitud de entrega                                                    |
...
| `transaction.shippingMethod.pickup`                                            | object  | Información de recogida                                                |
| `transaction.shippingMethod.pickup.pickupDate`                                 | string  | Fecha de recogida                                                      |
...
| `transaction.payments.extraCharges[].quantity`                                 | number  | Cantidad                                                               |
| `transaction.payments.extraCharges[].productId`                                | number  | ID de producto                                                         |
| `transaction.payments.extraCharges[].description`                              | string  | Descripción                                                            |
| `transaction.payments.extraCharges[].currencyCode`                             | string  | Código de moneda                                                       |
...
| `transaction.payments.extraCharges[].taxValue`                                 | number  | Valor de impuesto                                                      |
...
| `transaction.payments.paymentMethods`                                          | array   | Métodos de pago utilizados para la transacción                         |
...
| `transaction.payments.paymentMethods[].paymentMethodCode`                      | string  | Código de método de pago                                               |
...
| `transaction.payments.paymentMethods[].card`                                   | object  | Información de tarjeta                                                 |
| `transaction.payments.paymentMethods[].card.mask`                              | string  | Máscara de tarjeta                                                     |
| `transaction.payments.paymentMethods[].card.bin`                               | string  | BIN de tarjeta                                                         |
...
| `transaction.payments.paymentMethods[].card.holder`                            | string  | Titular de tarjeta                                                     |
...
| `transaction.marketing`                                                        | object  | Información utilizada para marketing                                   |
| `transaction.marketing.loyalty`                                                | object  | Programa de fidelización                                               |
...
| `transaction.additionalInfo.kiosk`                                             | object  | Información de kiosko                                                  |
| `transaction.additionalInfo.kiosk.ip`                                          | string  | IP del kiosko                                                          |
| `transaction.additionalInfo.pickupPhase`                                       | string  | Fase de recogida                                                       |
| `feBuilder`                                                                    | object  | Datos de facturación (respuesta de fe.builder)                         |
| `feBuilder.companyTaxData`                                                     | object  | Datos tributarios de la empresa                                        |
...
| `feBuilder.companyTaxData.obligatoryToKeepAccounts`                            | number  | Si está obligado a llevar contabilidad                                 |
...
| `feBuilder.dataInvocie`                                                        | object  | Datos devueltos por el sistema de facturación al crear factura         |
...
| `feBuilder.dataCredit`                                                         | object  | Datos devueltos al crear una nota de crédito                           |
| `feBuilder.dataCredit.sequential`                                              | string  | Secuencial de nota de crédito                                          |
...
| `pubDevice`                                                                    | object  | Datos de dispositivo (respuesta de pubDevice)                          |
...
| `promotions`                                                                   | object  | Datos de promociones (respuesta del sistema de promociones)            |
| `promotions.cupones`                                                           | object  | Información de cupones                                                 |
| `promotions.cupones.codeQr`                                                    | string  | Código QR del cupón                                                    |
