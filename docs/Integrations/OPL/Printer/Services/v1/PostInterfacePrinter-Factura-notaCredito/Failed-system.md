## Generar Factura Electrónica Ecuador
...
El cuerpo es extenso debido a la estructura completa de la transacción para generar factura electrónica. Ver JSON completo en la documentación.

### Descripción del Cuerpo de la Solicitud

| Campo                                                                               | Tipo    | Descripción                                                            |
| ----------------------------------------------------------------------------------- | ------- | ---------------------------------------------------------------------- |
| `typePrinter`                                                                       | string  | Tipo de documento electrónico (catálogo de tipos de documentos)        |
