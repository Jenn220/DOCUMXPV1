...
CONNECTION_ENTITY_DB_NAME=QA_KFC_MXPi_Printer
...
EXTRACT_REPOSITORY=QA_KFC_MXPi_FeBuild
...
EXTRACT_SETTINGS_REPOSITORY=QA_KFC_MXPi_Settings
...
LOAD_REPOSITORY=QA_KFC_MXPi_Printer
LOAD_ADAPTER=Mongo
```
...
CONNECTION_OPL_DB_NAME=QA_KFC_MXPi_Printer
...
CACHE_DB_NAME=QA_KFC_MXPi_Printer
