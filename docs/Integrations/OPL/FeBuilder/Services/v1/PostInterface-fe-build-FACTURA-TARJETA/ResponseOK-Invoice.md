## Generar Factura Electrónica con Tarjeta de Crédito
      ...
      "payment_methods": [
        {
          ...
          "payment_method_name": "Tarjeta débito / crédito*",
          "processor": "DEUNA",
          "currency_code": "USD",
          ...
          "additional_info_payment_methods": {
            ...
            "data_transaction": {
              ...
              "secuenciaTransaccion": "006423",
              "numeroLote": "000072",
              "horaTransaccion": "191017",
              "fechaTransaccion": "20250904",
              "numeroAutorizacion": "975456",
              "terminalID": "JVZ03001",
              "merchantID": "000000839676   ",
              "valorInteres": "            ",
              "mensajeriaImpresion": "        ",
              "codigoBancoAdquiriente": "   ",
              "codigobancoemisor": "                              ",
              "nombreGrupoTarjeta": "VISA ELECTRON            ",
              "modoLectura": 7,
              ...
              "tipoemv": "80                    ",
              "verificaPin": "               ",
              "arqc": "5581B6ADE4E775A4",
              "tvr": "0000000000",
              "tsi": "0000",
              "numTarjTrunca": "40483700XXXX0142         ",
              "fechVencTrj": "2805",
...
| `transaction.payments.payment_methods[].additional_info_payment_methods.external_reference`                          | string  | Referencia externa                                                     |
| `transaction.payments.payment_methods[].additional_info_payment_methods.method_name`                                 | string  | Nombre del método                                                      |
| `transaction.payments.payment_methods[].additional_info_payment_methods.data_transaction`                            | object  | Datos de transacción                                                   |
| `transaction.payments.payment_methods[].additional_info_payment_methods.data_transaction.tipoMensaje`                | number  | Tipo de mensaje                                                        |
| `transaction.payments.payment_methods[].additional_info_payment_methods.data_transaction.tipoRespuesta`              | number  | Tipo de respuesta                                                      |
| `transaction.payments.payment_methods[].additional_info_payment_methods.data_transaction.codigoAdquiriente`          | number  | Código del adquiriente                                                 |
| `transaction.payments.payment_methods[].additional_info_payment_methods.data_transaction.codigorespuestaAutorizador` | string  | Código de respuesta autorizador                                        |
| `transaction.payments.payment_methods[].additional_info_payment_methods.data_transaction.mensajeRespuesta`           | string  | Mensaje de respuesta                                                   |
| `transaction.payments.payment_methods[].additional_info_payment_methods.data_transaction.secuenciaTransaccion`       | string  | Secuencia de transacción                                               |
| `transaction.payments.payment_methods[].additional_info_payment_methods.data_transaction.numeroLote`                 | string  | Número de lote                                                         |
| `transaction.payments.payment_methods[].additional_info_payment_methods.data_transaction.horaTransaccion`            | string  | Hora de transacción                                                    |
| `transaction.payments.payment_methods[].additional_info_payment_methods.data_transaction.fechaTransaccion`           | string  | Fecha de transacción                                                   |
| `transaction.payments.payment_methods[].additional_info_payment_methods.data_transaction.numeroAutorizacion`         | string  | Número de autorización                                                 |
| `transaction.payments.payment_methods[].additional_info_payment_methods.data_transaction.terminalID`                 | string  | ID de terminal                                                         |
| `transaction.payments.payment_methods[].additional_info_payment_methods.data_transaction.merchantID`                 | string  | ID de comerciante                                                      |
| `transaction.payments.payment_methods[].additional_info_payment_methods.data_transaction.valorInteres`               | string  | Valor de interés                                                       |
| `transaction.payments.payment_methods[].additional_info_payment_methods.data_transaction.mensajeriaImpresion`        | string  | Mensajería de impresión                                                |
| `transaction.payments.payment_methods[].additional_info_payment_methods.data_transaction.codigoBancoAdquiriente`     | string  | Código del banco adquiriente                                           |
| `transaction.payments.payment_methods[].additional_info_payment_methods.data_transaction.codigobancoemisor`          | string  | Código del banco emisor                                                |
| `transaction.payments.payment_methods[].additional_info_payment_methods.data_transaction.nombreGrupoTarjeta`         | string  | Nombre del grupo de tarjeta                                            |
| `transaction.payments.payment_methods[].additional_info_payment_methods.data_transaction.modoLectura`                | number  | Modo de lectura                                                        |
| `transaction.payments.payment_methods[].additional_info_payment_methods.data_transaction.nombreTarjetaHabiente`      | string  | Nombre del tarjetahabiente                                             |
| `transaction.payments.payment_methods[].additional_info_payment_methods.data_transaction.montoFijo`                  | string  | Monto fijo                                                             |
| `transaction.payments.payment_methods[].additional_info_payment_methods.data_transaction.idemv`                      | string  | ID EMV (valida DEBITO o CREDITO)                                       |
| `transaction.payments.payment_methods[].additional_info_payment_methods.data_transaction.aidemv`                     | string  | AID EMV                                                                |
| `transaction.payments.payment_methods[].additional_info_payment_methods.data_transaction.tipoemv`                    | string  | Tipo EMV                                                               |
| `transaction.payments.payment_methods[].additional_info_payment_methods.data_transaction.verificaPin`                | string  | Verificación de PIN                                                    |
| `transaction.payments.payment_methods[].additional_info_payment_methods.data_transaction.arqc`                       | string  | ARQC                                                                   |
| `transaction.payments.payment_methods[].additional_info_payment_methods.data_transaction.tvr`                        | string  | TVR                                                                    |
| `transaction.payments.payment_methods[].additional_info_payment_methods.data_transaction.tsi`                        | string  | TSI                                                                    |
| `transaction.payments.payment_methods[].additional_info_payment_methods.data_transaction.numTarjTrunca`              | string  | Número de tarjeta truncada                                             |
| `transaction.payments.payment_methods[].additional_info_payment_methods.data_transaction.fechVencTrj`                | string  | Fecha de vencimiento de tarjeta                                        |
| `transaction.payments.payment_methods[].additional_info_payment_methods.data_transaction.numTarjEncri`               | string  | Número de tarjeta encriptado                                           |
| `transaction.payments.payment_methods[].additional_info_payment_methods.data_transaction.filler`                     | string  | Relleno                                                                |
...
```json
{
  ...
  "data": {
    ...
    "dataInvoice": {
      "sequential": "005-052-000000345",
      "accessKey": "YOUR_REDIS_OR_AZURE_KEY_HERE",
      "transaction": "G001F000000272",
        ...
        "payment_methods": [
          {
            ...
            "payment_methods_printer_name": "VISA - TAR. CRED."
          }
        ],
        "additional_data": [
          {
