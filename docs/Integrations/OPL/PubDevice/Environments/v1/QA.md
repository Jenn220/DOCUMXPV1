...
CONNECTION_ENTITY_DB_NAME=UAT_KFC_MXPi_Opl
...
```bash
EXTRACT_SERVER=ec-mxpv2-qa.irplcko.mongodb.net
EXTRACT_PORT=
EXTRACT_USER=app_uat_integration
EXTRACT_PASSWORD=2tg0tTzCxPMueq7I
EXTRACT_REPOSITORY=UAT_KFC_MXPi_Opl
...
```bash
CONNECTION_OPL_DB_HOST=ec-mxpv2-qa.irplcko.mongodb.net
CONNECTION_OPL_DB_PORT=
CONNECTION_OPL_DB_USER=app_uat_integration
CONNECTION_OPL_DB_PSWD=2tg0tTzCxPMueq7I
CONNECTION_OPL_DB_NAME=UAT_KFC_MXPi_Opl
...
CACHE_DB_PORT=
CACHE_DB_USER=app_uat_integration
CACHE_DB_PSWD=2tg0tTzCxPMueq7I
CACHE_DB_NAME=UAT_KFC_MXPi_Opl
