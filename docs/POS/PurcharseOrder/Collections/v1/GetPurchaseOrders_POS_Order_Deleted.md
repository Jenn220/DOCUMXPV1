## Obtener Órdenes de Compra Eliminadas
...
```json
{
  ...
  "invoice": {
    ...
    "dataInvoice": {
      "sequential": "097-987-000000215",
      "accessKey": "YOUR_REDIS_OR_AZURE_KEY_HERE",
      "transaction": "G002F000002622",
      ...
      "environment": "Pruebas",
      "createdAt": "2025-11-17T12:29:57.553Z",
      "document": {
        "client": {
          "client_id": "ECU1723593644",
          "name": "Jonathan ToapantasJonathan ToapantasJonathan Toapantas",
          "last_name": "",
          "phone": "0978868458",
          "email": "elian002620@gmail.com",
          "gov_id_type": "Cedula",
          "gov_id_number": "1723593644"
        },
        "orderInvoice": {
          "order_id": "2e7ec6c5-da93-4fe7-943f-e9bc4f32c214",
          "invoice_id": null,
  ...
  "credit_note": {
    "credit_note_number": "001-N-20251117123044-C-05-A",
    "date": {
      "$date": "2025-11-17T17:31:04.610Z"
    },
    "related_document": "",
    "observations": "sfdbfgnmghfd",
    "observation_paymment_cash": "",
    "reason": {
      "reason_id": {
        "$binary": {
          "base64": "fOYKdQ8US0qgN+uwfS356w==",
          "subType": "04"
        }
      },
      "reason_name": "Datos con error en factura"
    },
    "autorization": null
  },
  "driveThru": null,
  ...
  "cash_register_subscription": {
    "$binary": {
      "base64": "aXc20Lsxw+fWN0BF/SkuSw==",
      "subType": "04"
    }
  },
  "cash_register_subscription_name": "697736d0-bb31-c3e7-d637-4045fd292e4b",
  "seller": {
    "user_seller_id": {
      "$binary": {
        "base64": "cy6Aq+PgKT5ysEfgUipddg==",
        "subType": "04"
      }
    },
    "user_seller_name": "LUCIA VERONICA SUQUILANDA YAGUANA",
    "user_seller_rol": "Cajero",
    "user_seller_profile": "Cajero"
  },
  "status_order_id": {
    "$binary": {
      "base64": "YpMvG2FSZUywsQYCNWt5Mw==",
      "subType": "04"
    }
  },
  "period_id": {
    "$binary": {
      "base64": "W1WihYJaQgSFESOlK8DZDQ==",
      "subType": "04"
    }
  },
  "status_order_description": "Eliminada",
  "order_id_call": "",
  "ui_reference_uuid": "001-C-20251117122939-O-12-A",
  "ui_started_at": {
    "$date": "2025-11-17T17:29:41.233Z"
  },
  "ui_finished_at": {
    "$date": "2025-11-17T17:30:00.240Z"
  },
  "totals": {
    "result_presentation": {
      "taxes": [
  ...
  "items": [
    ...
    },
    {
      ...
      "classification_description": "Llevar",
      "plu_parent_id": "f55cf73f-4e93-4dac-a559-a2c01422b567",
      "plu_id": {
        "$binary": {
          "base64": "Pf3YFmEepXmyaS0Dm11KcA==",
          "subType": "04"
  ...
  "customer": {
    "_id": "ECU1723593644",
    "id_user_external": "653da116f285864413d7ccee",
    "name": "Jonathan ToapantasJonathan ToapantasJonathan Toapantas",
    "document_type": "Cedula",
    "document_number": "1723593644",
    "email": "elian002620@gmail.com",
    "contact_number": "0978868458",
    "share_personal_data": false,
    "is_end_customer": false
  },
  "authorizations": [],
  "payments": [
    {
  ...
  "created_at": {
    "$date": "2025-11-17T17:35:01.377Z"
  },
  "updated_at": {
    "$date": "2025-11-17T17:35:01.282Z"
  }
}
```
