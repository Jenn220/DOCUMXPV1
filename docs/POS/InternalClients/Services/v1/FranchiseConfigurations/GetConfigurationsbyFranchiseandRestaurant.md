## Obtener Configuraciones por Franquicia y Restaurante
...
```
{{server_internalClients}}/api/v1/franchiseconfigurations/get_configurations_by_franchise_and_restaurant
```
