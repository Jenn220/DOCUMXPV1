## Asociar Restricciones de PLU a Categoría del Menú
...
```
{{server_BO_Menus}}/api/v1/menu/asocciate_restrictions_plu_to_category_menu_to_menu
```
...
| `plu_id`                              | string   | ID del PLU a restringir                 |
