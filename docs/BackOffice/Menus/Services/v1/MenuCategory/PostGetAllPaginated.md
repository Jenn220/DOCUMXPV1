## Obtener Todas las Categorías de Menú Paginadas
...
```
{{server_BO_Menus}}/api/v1/menucategory/getall_paginated
```
...
| `filter`     | string | Término de búsqueda para filtrar categorías   |
| `menu_id`    | string | ID del menú para filtrar categorías asociadas |
