## Obtener Todos Paginados por Horario de Programación
...
| `programmation_price` | `string`                               | ID de programación de precio |
...
| `filter`     | string | Término de búsqueda para filtrar         |
